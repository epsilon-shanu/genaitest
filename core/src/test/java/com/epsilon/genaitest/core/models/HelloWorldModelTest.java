 ...
 */
package com.epsilon.genaitest.core.models;
...
import com.epsilon.genaitest.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "genaitest/components/helloworld");
